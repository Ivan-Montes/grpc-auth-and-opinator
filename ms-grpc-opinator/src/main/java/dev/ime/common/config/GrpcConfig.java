...
import dev.proto.ReviewGrpcCommandServiceGrpc;
import dev.proto.VoteGrpcCommandServiceGrpc;
...
public class GrpcConfig {
	...
	GrpcSecurityMetadataSource grpcSecurityMetadataSource() {
	    ...
	    source.set(ReviewGrpcCommandServiceGrpc.getCreateReviewMethod(), AccessPredicate.authenticated());
	    source.set(ReviewGrpcCommandServiceGrpc.getUpdateReviewMethod(), AccessPredicate.authenticated());
	    source.set(ReviewGrpcCommandServiceGrpc.getDeleteReviewMethod(), AccessPredicate.authenticated());
	    source.set(VoteGrpcCommandServiceGrpc.getCreateVoteMethod(), AccessPredicate.authenticated());
	    source.set(VoteGrpcCommandServiceGrpc.getUpdateVoteMethod(), AccessPredicate.authenticated());
	    source.set(VoteGrpcCommandServiceGrpc.getDeleteVoteMethod(), AccessPredicate.authenticated());
